...
import com.second.storyPedia.services.PlaceService;
import com.second.storyPedia.services.StoryService;
import com.second.storyPedia.services.UserService;
...
public class StoryController {
	...
	public String newStory(@ModelAttribute("addNewStory") Story story,
			HttpSession session,
			Model model) {
...
//		 Story story=storyService.findStory(id);
//		 User user = userService.findById(userId);
//		 storyService.unLike(story,user);
//		 return "redirect:/stories"; 
//	 }
