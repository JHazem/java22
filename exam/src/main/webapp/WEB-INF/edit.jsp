...
<div class="container"></br>
	 <h3> Change <c:out value="${bundler.babyName}"/></h3></br> 
	<div class="container">
	
	<form:form action="/bundlers/${bundler.id}" modelAttribute="bundler" class="form" method="post">
			<!-- <input type="hidden" name="_method" value="put"/> -->
			<form:hidden path="user"   name="_method" value="${bundler.user.id}"/>
				<div class="form-row">
			...
			<div></br></br>
			<button><a href="/bundlers">Cancel</a></button>
 			...
 			<button style="background-color:Red;" >
				<a href="/bundlers/delete/<c:out value="${bundler.id}"/>">Delete</a>  <!-- Delete Link -->						
	  		</button>
			</div>	
</div>
</body>
